...
function renderizarProductos(products){
    for(const prod of products){
        $('#almacen').append(`
            ...
            <a href="#div-tabla" class="btn btn-primary" id="btn-${prod.id}">Agregar al carrito🛒</a>
            </div>
        </div>`);
      //Le agregamos a cada boton la funcion para que lo agregue al carrito
...
function agregarAlCarrito(prodACarro){
    ...
    if(encontrado == undefined){
        ...
        Swal.fire(`Nuevo producto agregado al carrito\n<strong>${prodACarro.producto}</strong>`);
        ...
        //Si el producto ya existe en el carrito, buscamos el indice de ese producto
    ...
    showCart()
    //Enviamos el carrito al Storage
